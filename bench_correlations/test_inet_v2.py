""" Get the accuracies on ImageNet_V2 of the models defined in ../models.py
...
test_set = data.get_Inet1K_V2(dataset_path, album_mode)
...
res_array.to_pickle(os.path.join("../Results/benchmark_correlations","inet_v2_accuracies.pkl"))
res_array.to_html(os.path.join("../Results/benchmark_correlations","inet_v2_accuracies.html"))
