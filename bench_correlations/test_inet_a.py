""" Get the accuracies on ImageNet-A of the models defined in ../models.py
...
test_set = data.get_Inet_a(dataset_path, album_mode)
...
res_array.to_pickle(os.path.join("../Results/benchmark_correlations","inet_a_accuracies.pkl"))
res_array.to_html(os.path.join("../Results/benchmark_correlations","inet_a_accuracies.html"))
